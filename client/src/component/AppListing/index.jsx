...
export default function AppListing({ id, position, company, stage, notes, dates }) {
  ...
  return (
    <div className="app-listing">
      <div className="listing-categories-main">
        ...
        <button onClick={() => deleteJob(id)} className="delete-app">
      ...
      <FullApp fullView={fullView} id={id} stage={stage} notes={notes} dates={dates} />
    </div>
  );
}
